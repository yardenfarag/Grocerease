...
const initialStoreState = {filterBy: {txt: ''}, curStore: null as Store | null, 
stores: storeService.getStores(), icons: storeService.getIcons()}
...
const storeSlice = createSlice({
    ...
    reducers: {
        ...
        addStore: (state, action: PayloadAction<{newStoreTitle:string, selectedColor:string}>) => {
          ...
          state.stores = storeService.getStores()
        }
    }
})
